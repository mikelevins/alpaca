...
(defparameter |Orderable| (%construct-class 'bard::|Orderable| (list |Atom|)))
...
(defparameter |Number| (%construct-class 'bard::|Number| (list |Orderable|)))
...
(defparameter |Character| (%construct-class 'bard::|Character| (list |Orderable|)))
